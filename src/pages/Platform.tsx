...
export const PlatformPage = () => {
  ...
  return (
    <div className="page-wrap font-sans selection:bg-cyan-500/30">
      ...
      {/* Hero Section — brand block grouped; row justify-start aligns to inline-start (physical right under dir=rtl) */}
      <div className="relative w-full pb-8 sm:pb-10 overflow-hidden">
        {platform && (
          <>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 w-full flex flex-row justify-start">
              <div className="flex min-w-0 max-w-full flex-col items-start text-start gap-4 sm:gap-5 md:gap-6">
                ...
                <h1 className="text-4xl md:text-6xl font-black tracking-tight text-white text-start uppercase max-w-full leading-tight">
                  {platform.name}
                </h1>

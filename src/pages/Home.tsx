...
import { PlatformStorefrontGrid } from '../components/PlatformStorefrontGrid';
import { supabase } from '../lib/supabase';
import { useStore } from '../store/useStore';
import type { Platform } from '../types';
import { showToast } from '../components/Toast';
import { fetchStorefrontProductsByPlatform } from '../utils/fetchStorefrontProducts';
...
export const Home = () => {
  ...
  const loadPlatforms = async () => {
    try {
      ...
      const productsData = await fetchStorefrontProductsByPlatform(platformIds);
  ...
  return (
    <div className="page-wrap">
      ...
      <div className="page-content-wide">
        ...
        <PlatformStorefrontGrid
          loading={loading}
          platforms={platforms}
          onSelectPlatform={(platformId) => navigate(`/platform/${platformId}`)}
          emptyState={
